...
| | |
|---|---|
| Status | APPROVED 2026-09-13 - the operator ordered the review completed by the record ("do it yourself", 2026-09-13); review of record in RECORD.md 43. Part 1: bodies and age - the child-body conclusion is shipped in SAO (C29-C33, C35; the corrected ModelInstance.scale claim stands withdrawn as written). Part 2: traits and health conditions. Part 3: repositories and non-Workshop hosts. Part 4: the Week One and Bandits art inventory, selected and shipped 2026-09-07 (SAO's DR-034, batch C35). Feeds DR-032 on the SAO side: which mods SAO requires, takes from, or declines is decided through Crucible, mod by mod - and is decided; this catalogue is the record of what was decided, not a proposal. |
